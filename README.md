...
* `DebugMode`: initial value of the GUI's Debug Mode; keep this false for now!
...
* `Inspectors`: list of people who may use the GUI (currently not in use)
...
The class `Keithley2400.py` is an older version of `Keithley2410.py`.
